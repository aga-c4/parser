...
class ParserPg {
    ...
    public function upload(){
        ...
        if (true||$this->url!='https://test.domain/search?word=cisco&count=0'){
            ...
            if ($this->url=='https://test.domain/search?word=cisco&count=0') SysBf::saveFile('tmp/test-source.csv',$this->content); 
        }else{
